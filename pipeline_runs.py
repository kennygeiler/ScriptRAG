    ...
    with driver.session() as session:
        ...
        session.run(
            ...
            CREATE (p:PipelineRun {
                ...
                langsmith_tokens: toInteger($langsmith_tokens),
                langsmith_cost_usd: $langsmith_cost_usd,
            ...
            langsmith_tokens=langsmith_tokens,
            langsmith_cost_usd=float(langsmith_cost_usd),
