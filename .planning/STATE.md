...
status: in_progress
stopped_at: Phase 11 HITL-01 shipped — Verify evidence + scene grouping
...
Phase: **11** of v1.3 (3 phases) — **11 complete**; **12–13** not started  
Plan: `11-01-SUMMARY.md`  
...
- Phase **12** (HITL-02): filter/sort + optional bulk duplicate approve.
